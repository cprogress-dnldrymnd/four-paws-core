...
if ( ! class_exists( 'AcademistCoreDashboardRestAPI' ) ) {
	 ...
	 */
	class AcademistCoreDashboardRestAPI {
		...
		public function __construct() {
			// Init variables
			$this->set_namespace( 'academist-core/v1' );
			$this->set_route( 'dashboard' );

			// Localize theme's main js script with rest variable
			add_filter( 'academist_core_dashboard_filter_js_global_variables', array( $this, 'localize_script' ) );
	...
	AcademistCoreDashboardRestAPI::get_instance();
}